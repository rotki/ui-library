...
const minYear = computed(() => {
  if (minPage.value != null)
    return minPage.value.year;
  if (maxPage.value != null)
    return maxPage.value.year - 200;
  return defaultMinYear;
});

const maxYear = computed(() => {
  if (maxPage.value != null)
    return maxPage.value.year;
  if (minPage.value != null)
    return minPage.value.year + 200;
