...
describe('components/color-picker/RuiColorPicker.vue', () => {
  let wrapper: VueWrapper<InstanceType<typeof RuiColorPicker>>;
  ...
  it('should ui reflects the initial value', async () => {
    ...
    expect(wrapper.findAll<HTMLInputElement>('input').at(1)!.element.value).toBe('0');
    expect(wrapper.findAll<HTMLInputElement>('input').at(2)!.element.value).toBe('0');
    ...
    // RGB input value reflected
    expect(wrapper.findAll<HTMLInputElement>('input').at(0)!.element.value).toBe('128');
    expect(wrapper.findAll<HTMLInputElement>('input').at(1)!.element.value).toBe('255');
  ...
  it('should type on the input', async () => {
    wrapper = createWrapper();
    await vi.runAllTimersAsync();
